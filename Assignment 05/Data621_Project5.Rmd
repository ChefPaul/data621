...
author: "Javern Wilson, Joseph Simone, Jack Russo, Paul Perez"
date: "4/27/2020"
output:
  pdf_document:
    toc: yes
...
```
```{r}
wine_train <- read.csv("https://raw.githubusercontent.com/ChefPaul/data621/master/Assignment%2005/wine-training-data.csv")
wine_eval <- read.csv("https://raw.githubusercontent.com/ChefPaul/data621/master/Assignment%2005/wine-evaluation-data.csv")
```
## DATA EXPLORATION
### Preview
```{r}
...
[Full Test Set Here](https://raw.githubusercontent.com/ChefPaul/data621/master/Assignment%2005/wine_predictions.csv)

Source code found on [GITHUB](https://github.com/ChefPaul/data621/blob/master/Assignment%2005/Data621_Project5.Rmd)
